...
public class AddressManager {
	...
	public String addAddressBook(String name)
	{
		...
		if(controller.isAddressBookExists(name).equals(Constants.SUCSESS))
	...
	public String isAddressBookExists(String addressBook) {
		if(!Utility.validateStringForAlphanumericOflength20(addressBook))
			return "AddressBook Name should be Alphanumeric of Length 3-20 And Start with a Letter";
		else if(controller.isAddressBookExists(addressBook).equals(Constants.SUCSESS))
	...
	{
		if(controller.isAddressExists(id, addressBook).equals(Constants.SUCSESS))
	...
	{
		if(!controller.isAddressExists(bean.getId(), addressBook).equals(Constants.SUCSESS))
